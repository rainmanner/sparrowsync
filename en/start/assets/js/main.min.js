...
!(function (e, t) {
  ...
  function u(e) {
    var t = {};
    return (
      Ee.each(e.match(qe) || [], function (e, n) {
        t[n] = !0;
      }),
      t
    );
  ...
  function d() {
    ue.removeEventListener("DOMContentLoaded", d),
    ...
    for (var n, r, o = [], i = 0, a = e.length; a > i; i++)
      (r = e[i]),
        r.style &&
          ...
          t
            ? ("none" === n &&
                ((o[i] = ze.get(r, "display") || null),
                o[i] || (r.style.display = "")),
              "" === r.style.display && Je(r) && (o[i] = b(r)))
            : "none" !== n && ((o[i] = "none"), ze.set(r, "display", n)));
    ...
    return (
      (n =
        "undefined" != typeof e.getElementsByTagName
          ...
          : []),
      void 0 === t || (t && i(e, t)) ? Ee.merge([e], n) : n
    );
  }
  function C(e, t) {
              ...
              i.length &&
                (ze.set(this, t, {
                  value: Ee.event.trigger(
                    Ee.extend(i[0], Ee.Event.prototype),
                    i.slice(1),
                    this
                  ),
                }),
  ...
  function O(e, t) {
    ...
    if (1 === t.nodeType) {
      if (
        ze.hasData(e) &&
        ((i = ze.access(e)), (a = ze.set(t, i)), (l = i.events))
      ) {
      ...
      We.hasData(e) &&
        ((s = We.access(e)), (u = Ee.extend({}, s)), We.set(t, u));
    }
  }
  function H(e, t) {
  ...
  function P(e, t, r, o) {
    ...
    var i,
      ...
      h = t[0],
      m = xe(h);
    if (m || (d > 1 && "string" == typeof h && !be.checkClone && dt.test(h)))
    ...
    if (
      ...
      for (s = Ee.map(w(i, "script"), L), u = s.length; d > f; f++)
        (l = i),
          f !== p &&
            ((l = Ee.clone(l, !0, !0)), u && Ee.merge(s, w(l, "script"))),
          r.call(e[f], l, f);
      if (u)
        for (c = s[s.length - 1].ownerDocument, Ee.map(s, D), f = 0; u > f; f++)
          (l = s[f]),
            ot.test(l.type || "") &&
              !ze.access(l, "globalEval") &&
              Ee.contains(c, l) &&
  ...
  function q(e, t, n) {
    for (var r, o = t ? Ee.filter(t, e) : e, i = 0; null != (r = o[i]); i++)
      n || 1 !== r.nodeType || Ee.cleanData(w(r)),
        r.parentNode &&
          (n && Ke(r) && C(w(r, "script")), r.parentNode.removeChild(r));
    return e;
  }
  function M(e, t, n) {
    var r,
  ...
  function F(e, t, n, r, o, i) {
    ...
    for (; 4 > a; a += 2)
      "margin" === n && (u += Ee.css(e, n + Ve[a], !0, o)),
        r
          ? ("content" === n && (u -= Ee.css(e, "padding" + Ve[a], !0, o)),
            "margin" !== n &&
              (u -= Ee.css(e, "border" + Ve[a] + "Width", !0, o)))
          : ((u += Ee.css(e, "padding" + Ve[a], !0, o)),
            "padding" !== n
              ? (u += Ee.css(e, "border" + Ve[a] + "Width", !0, o))
              : (s += Ee.css(e, "border" + Ve[a] + "Width", !0, o)));
    return (
      !r &&
        i >= 0 &&
        (u +=
  ...
  function z(e, t, n) {
    ...
    return (
      ((!be.boxSizingReliable() && i) ||
        "auto" === s ||
        (!parseFloat(s) && "inline" === Ee.css(e, "display", !1, r))) &&
        e.getClientRects().length &&
        ((i = "border-box" === Ee.css(e, "boxSizing", !1, r)),
        (a = u in e),
        a && (s = e[u])),
      (s = parseFloat(s) || 0),
      s + F(e, t, n || (i ? "border" : "content"), a, r, s) + "px"
    );
  }
  ...
  function U() {
    St &&
      (ue.hidden === !1 && e.requestAnimationFrame
        ? e.requestAnimationFrame(U)
        : e.setTimeout(U, Ee.fx.interval),
      Ee.fx.tick());
  }
  function X() {
    return (
      ...
      for (r in p)
        u ||
          (g
            ...
            : (g = ze.access(e, "fxshow", { display: l })),
          i && (g.hidden = !m),
          m && x([e], !0),
          d.done(function () {
  ...
  function K(e, t, n) {
    ...
    for (G(c, l.opts.specialEasing); a > i; i++)
      if ((r = K.prefilters[i].call(l, e, c, l.opts)))
        return (
          xe(r.stop) &&
            (Ee._queueHooks(l.elem, l.opts.queue).stop = r.stop.bind(r)),
          r
        );
    return (
      Ee.map(c, Y, l),
  ...
  (Ee.fn = Ee.prototype =
    ...
    Ee.extend({
      ...
      isPlainObject: function (e) {
        var t, n;
        return e && "[object Object]" === me.call(e)
          ? (t = le(e))
  ...
  var ke = (function (e) {
    function t(e, t, n, r) {
      ...
      if (
        !r &&
        ((t ? t.ownerDocument || t : $) !== O && D(t), (t = t || O), P)
      ) {
        if (11 !== h && (u = be.exec(e)))
          if ((o = u[1])) {
            if (9 === h) {
      ...
      return (
        ...
        r(function (r, a, s, u) {
          var l,
            ...
            b = n ? (i || (r ? e : h || o) ? [] : a) : y;
          if ((n && n(y, b, s, u), o))
            for (l = v(b, p), o(l, [], s, u), c = l.length; c--; )
              (f = l[c]) && (b[p[c]] = !(y[p[c]] = f));
          if (r) {
            if (i || e) {
              if (i) {
      ...
      var o = n.length > 0,
        ...
        a = function (r, a, s, u, l) {
          ...
          for (
            ...
            if (i && c) {
              for (
                f = 0, a || c.ownerDocument === O || (D(c), (s = !P));
                (d = e[f++]);
          ...
          if (((p += h), o && h !== p)) {
            ...
            if (r) {
              if (p > 0) for (; h--; ) m[h] || g[h] || (g[h] = K.call(u));
              g = v(g);
            }
            J.apply(u, g),
    ...
    try {
      J.apply((G = ee.call($.childNodes)), $.childNodes),
        ...
        function (e) {
          ...
          return r !== O && 9 === r.nodeType && r.documentElement
            ? ((O = r),
              ...
              (C.getElementsByClassName = ye.test(O.getElementsByClassName)),
              ...
              (M = []),
              (q = []),
              (C.qsa = ye.test(O.querySelectorAll)) &&
                (o(function (e) {
                    ...
                    return n
                      ...
                      : ((n =
                        ...
                        (!C.sortDetached && t.compareDocumentPosition(e) === n)
                          ? e === O || (e.ownerDocument === $ && R($, e))
                            ? -1
                            : t === O || (t.ownerDocument === $ && R($, t))
                            ? 1
                            : I
                            ? te(I, e) - te(I, t)
                            : 0
        ...
        function (e, t, n, r) {
          ...
          if (((n = n || []), 1 === c.length)) {
            if (
              ...
              if (
                ((t = (T.find.ID(a.matches[0].replace(we, Ce), t) || [])[0]),
                !t)
              )
                return n;
        ...
        if ("string" != typeof e)
          return this.pushStack(
            Ee(e).filter(function () {
              for (t = 0; r > t; t++) if (Ee.contains(o[t], this)) return !0;
            })
          );
        ...
        if (r[1]) {
          if (
            ...
            Ee.merge(
              ...
              Ee.parseHTML(
                r[1],
                t && t.nodeType ? t.ownerDocument || t : ue,
                !0
              )
            ),
            Ie.test(r[1]) && Ee.isPlainObject(t))
          )
            for (r in t) xe(this[r]) ? this[r](t[r]) : this.attr(r, t[r]);
          return this;
        }
        return (
          (o = ue.getElementById(r[2])),
      ...
      function (e, t) {
        Ee.fn[e] = function (n, r) {
          ...
          return (
            ...
            this.length > 1 &&
              (Pe[e] || Ee.uniqueSort(o), He.test(e) && o.reverse()),
            this.pushStack(o)
          );
        };
      }
    ...
    Ee.extend({
          ...
          o = {
            ...
            then: function (t, r, o) {
              ...
              return Ee.Deferred(function (e) {
                n[0][3].add(i(0, e, xe(o) ? o : l, e.notifyWith)),
                  n[1][3].add(i(0, e, xe(t) ? t : l)),
                  n[2][3].add(i(0, e, xe(r) ? r : c));
              }).promise();
            },
            promise: function (e) {
      ...
      when: function (e) {
        ...
        if (
          ...
          "pending" === i.state() || xe(o[n] && o[n].then))
        )
          return i.then();
    ...
    Ee.extend({
      ...
      ready: function (e) {
        (e === !0 ? --Ee.readyWait : Ee.isReady) ||
          ((Ee.isReady = !0),
          (e !== !0 && --Ee.readyWait > 0) || _e.resolveWith(ue, [Ee]));
      },
    }),
    ...
    Ee.fn.extend({
      data: function (e, t) {
        ...
        if (void 0 === e) {
          if (
            this.length &&
            ((o = We.get(i)), 1 === i.nodeType && !ze.get(i, "hasDataAttrs"))
          ) {
            for (n = a.length; n--; )
              a[n] &&
                ((r = a[n].name),
      ...
      queue: function (e, t, n) {
        ...
        return e
          ? ((t = (t || "fx") + "queue"),
            ...
            n &&
              (!r || Array.isArray(n)
                ? (r = ze.access(e, t, Ee.makeArray(n)))
                : r.push(n)),
            r || [])
          : void 0;
      },
  ...
  Ge.getRootNode &&
    (Ke = function (e) {
      return (
        Ee.contains(e.ownerDocument, e) || e.getRootNode(Ze) === e.ownerDocument
      );
    });
  var Je = function (e, t) {
      return (
        ...
        "none" === e.style.display ||
          ("" === e.style.display && Ke(e) && "none" === Ee.css(e, "display"))
      );
    },
    et = function (e, t, n, r) {
      var o,
  ...
  (Ee.event = {
      ...
      if (g)
        for (
          n.handler && ((i = n), (n = i.handler), (o = i.selector)),
            o && Ee.find.matchesSelector(Ge, o),
            n.guid || (n.guid = Ee.guid++),
            (u = g.events) || (u = g.events = {}),
            (a = g.handle) ||
              (a = g.handle =
                function (t) {
                  return "undefined" != typeof Ee &&
    ...
    dispatch: function (e) {
      ...
      if (
        ...
        for (
          a = Ee.event.handlers.call(this, s, l), t = 0;
          ...
          for (
            ...
            (s.rnamespace &&
              ...
              (s.data = i.data),
              (r = (
                (Ee.event.special[i.origType] || {}).handle || i.handler
              ).apply(o.elem, u)),
              void 0 !== r &&
                (s.result = r) === !1 &&
    ...
    special: {
      ...
      click: {
        setup: function (e) {
          var t = this || e;
          return (
            nt.test(t.type) && t.click && i(t, "input") && j(t, "click", E), !1
          );
        },
        trigger: function (e) {
          var t = this || e;
          return (
            nt.test(t.type) && t.click && i(t, "input") && j(t, "click"), !0
          );
        },
        _default: function (e) {
          var t = e.target;
  ...
  Ee.extend({
    ...
    clone: function (e, t, n) {
      ...
      if (t)
        if (n)
          for (i = i || w(e), a = a || w(s), r = 0, o = i.length; o > r; r++)
            O(i[r], a[r]);
        else O(e, s);
      return (
        (a = w(s, "script")), a.length > 0 && C(a, !u && w(e, "script")), s
      );
    },
    ...
    Ee.each(
      ...
      function (e, t) {
        Ee.fn[e] = function (e) {
          for (var n, r = [], o = Ee(e), i = o.length - 1, a = 0; i >= a; a++)
      ...
      _default: {
        ...
        set: function (e) {
          Ee.fx.step[e.prop]
            ? Ee.fx.step[e.prop](e)
            : 1 !== e.elem.nodeType ||
              (!Ee.cssHooks[e.prop] && null == e.elem.style[B(e.prop)])
            ? (e.elem[e.prop] = e.now)
          ...
          return "undefined" == typeof e.getAttribute
            ...
            : ((1 === i && Ee.isXMLDoc(e)) ||
                (o =
                  ...
                  (Ee.expr.match.bool.test(t) ? Nt : void 0)),
              void 0 !== n
                ? null === n
    ...
    Ee.extend({
      prop: function (e, t, n) {
        ...
        if (3 !== i && 8 !== i && 2 !== i)
          return (
            (1 === i && Ee.isXMLDoc(e)) ||
              ((t = Ee.propFix[t] || t), (o = Ee.propHooks[t])),
            void 0 !== n
              ? o && "set" in o && void 0 !== (r = o.set(e, n, t))
                ? r
                : (e[t] = n)
      ...
      toggleClass: function (e, t) {
        ...
        return "boolean" == typeof t && r
          ...
          : this.each(function () {
              var t, o, i, a;
              if (r)
                for (o = 0, i = Ee(this), a = ee(e); (t = a[o++]); )
                ...
                (void 0 !== e && "boolean" !== n) ||
                  ...
                  this.setAttribute &&
                    this.setAttribute(
                      "class",
                      t || e === !1 ? "" : ze.get(this, "__className__") || ""
                    ));
            });
      },
      hasClass: function (e) {
  ...
  Ee.fn.extend({
    val: function (e) {
        ...
        o = this[0];
      {
        ...
        if (o)
          return (
            (t = Ee.valHooks[o.type] || Ee.valHooks[o.nodeName.toLowerCase()]),
    ...
    Ee.extend({
      valHooks: {
        ...
        select: {
          ...
          set: function (e, t) {
            for (
              var n, r, o = e.options, i = Ee.makeArray(t), a = o.length;
              a--;

            )
              (r = o[a]),
                (r.selected = Ee.inArray(Ee.valHooks.option.get(r), i) > -1) &&
                  (n = !0);
      ...
      (Ee.valHooks[this] = {
        set: function (e, t) {
          return Array.isArray(t)
            ? (e.checked = Ee.inArray(Ee(e).val(), t) > -1)
            : void 0;
        },
      }),
        be.checkOn ||
    ...
    trigger: function (t, n, r, o) {
      ...
      if (
        ...
        if (!o && !f.noBubble && !we(r)) {
          for (
            u = f.delegateType || h, Ot.test(u + h) || (a = a.parentNode);
            a;
            a = a.parentNode
          )
            p.push(a), (s = a);
          s === (r.ownerDocument || ue) &&
        ...
        return (
          ...
          o ||
            ...
            (l &&
              ...
              t.isPropagationStopped() && d.addEventListener(h, Ht),
              r[h](),
              t.isPropagationStopped() && d.removeEventListener(h, Ht),
    ...
    Ee.extend({
      ...
      ajax: function (t, n) {
            ...
            l
              ? (h.ifModified &&
                ...
                204 === t || "HEAD" === h.type
                  ...
                  : 304 === t
                  ? (C = "notmodified")
                  : ((C = x.state), (d = x.data), (p = x.error), (l = !p)))
              : ((p = C), (!t && C) || ((C = "error"), 0 > t && (t = 0))),
            (T.status = t),
            (T.statusText = (n || C) + ""),
            l ? v.resolveWith(m, [d, C, T]) : v.rejectWith(m, [T, C, p]),
            T.statusCode(b),
            (b = void 0),
            f && g.trigger(l ? "ajaxSuccess" : "ajaxError", [T, h, l ? d : p]),
            y.fireWith(m, [T, C]),
            f &&
        ...
        (f = Ee.event && h.global),
          ...
          h.hasContent
            ...
            : ((p = h.url.slice(i.length)),
              h.data &&
                ...
                ((i += (Mt.test(i) ? "&" : "?") + h.data), delete h.data),
              h.cache === !1 &&
                ((i = i.replace(Wt, "$1")),
                (p = (Mt.test(i) ? "&" : "?") + "_=" + qt++ + p)),
              (h.url = i + p)),
          h.ifModified &&
            (Ee.lastModified[i] &&
              T.setRequestHeader("If-Modified-Since", Ee.lastModified[i]),
            Ee.etag[i] && T.setRequestHeader("If-None-Match", Ee.etag[i])),
          ...
          T.setRequestHeader(
            ...
            h.dataTypes[0] && h.accepts[h.dataTypes[0]]
              ? h.accepts[h.dataTypes[0]] +
                  ("*" !== h.dataTypes[0] ? ", " + Kt + "; q=0.01" : "")
              : h.accepts["*"]
          );
        for (d in h.headers) T.setRequestHeader(d, h.headers[d]);
        if (h.beforeSend && (h.beforeSend.call(m, T, h) === !1 || c))
          return T.abort();
        if (
          ((C = "abort"),
          y.add(h.complete),
  ...
  Ee.ajaxSetup({
    ...
    Ee.ajaxPrefilter("json jsonp", function (t, n, r) {
      ...
      return s || "jsonp" === t.dataTypes[0]
        ? ((o = t.jsonpCallback =
          ...
          r.always(function () {
            void 0 === i ? Ee(e).removeProp(o) : (e[o] = i),
              t[o] && ((t.jsonpCallback = n.jsonpCallback), tn.push(o)),
              a && xe(i) && i(a[0]),
              (a = i = void 0);
          }),
          "script")
    ...
    Ee.each(["top", "left"], function (e, t) {
      Ee.cssHooks[t] = _(be.pixelPosition, function (e, n) {
        return n
          ? ((n = M(e, t)), ht.test(n) ? Ee(e).position()[t] + "px" : n)
          : void 0;
      });
    }),
  ...
  return (
    (Ee.noConflict = function (t) {
      return (
        e.$ === Ee && (e.$ = on), t && e.jQuery === Ee && (e.jQuery = rn), Ee
      );
    }),
    t || (e.jQuery = e.$ = Ee),
    Ee
  ...
  (function (e) {
    ...
    e.fn.fitVids = function (t) {
      ...
      if (!document.getElementById("fit-vids-style")) {
        ...
        (i.innerHTML = '<p>x</p><style id="fit-vids-style">' + o + "</style>"),
              ...
              if (
                ...
                var o =
                    ...
                    (n.attr("height") && !isNaN(parseInt(n.attr("height"), 10)))
                      ...
                      : n.height(),
                  i = isNaN(parseInt(n.attr("width"), 10))
                    ? n.width()
  ...
  $(function () {
    function e() {
      (u = n.width() - 10),
        ...
        (c = s[l - 1]),
        c > u
          ? (n.children().last().prependTo(r), (l -= 1), e())
          : u > s[l] && (r.children().first().appendTo(n), (l += 1), e()),
        t.attr("count", o - l),
        l === o ? t.addClass("hidden") : t.removeClass("hidden");
    }
    ...
    $(window).resize(function () {
      ...
      t.on("click", function () {
        r.toggleClass("hidden"), clearTimeout(f);
      }),
      r
    ...
    (b.prototype = {
      ...
      updateItemHTML: function () {
        ...
        if (
          ...
          E("FirstMarkupParse", i),
            i ? (t.currTemplate[r] = e(i)) : (t.currTemplate[r] = !0);
        }
              ...
              if (i.length > 0) {
                ...
                "replaceWith" === a
                  ...
                  ? i.is("img")
                    ? i.attr("src", r)
                    : i.replaceWith(
                        e("<img>").attr("src", r).attr("class", i.attr("class"))
                      )
                  : i.attr(o[1], r);
              }
      ...
      (e.fn.magnificPopup = function (n) {
        ...
        if ("string" == typeof n)
          if ("open" === n) {
            var o,
              i = x ? r.data("magnificPopup") : r[0].magnificPopup,
          ...
          (n = e.extend(!0, {}, n)),
            x ? r.data("magnificPopup", n) : (r[0].magnificPopup = n),
            t.addGroup(r, n);
        return r;
      });
    var N,
        ...
        getInline: function (n, r) {
          if ((D(), n.src)) {
            ...
            if (i.length) {
              ...
              a &&
                a.tagName &&
                (j || ((N = o.hiddenClass), (j = T(N)), (N = "mfp-" + N)),
                (I = i.after(j).detach().removeClass(N))),
        ...
        getImage: function (n, r) {
          ...
          if (u.length) {
            ...
            (l.className = "mfp-img"),
              ...
              (n.img = e(l).on("load.mfploader", i).on("error.mfploader", a)),
              (l.src = n.src),
              u.is("img") && (n.img = n.img.clone()),
              (l = n.img[0]),
              l.naturalWidth > 0
                ? (n.hasSize = !0)
                : l.width || (n.hasSize = !1);
          ...
          return (
            t._parseMarkup(r, { title: _(n), img_replaceWith: n.img }, n),
            t.resizeImage(),
            n.hasSize
              ? (M && clearInterval(M),
                n.loadError
                  ? (r.addClass("mfp-loading"),
                    t.updateStatus("error", s.tError.replace("%url%", n.src)))
                  : (r.removeClass("mfp-loading"), t.updateStatus("ready")),
                r)
      ...
      function (e, n, o, i) {
        function a() {
          ...
          i && !s && r(),
            ...
            i === t && c > e
              ? r()
              : n !== !0 && (s = setTimeout(i ? a : r, i === t ? e - c : e));
        }
        var s,
          u = 0;
        return (
          "boolean" != typeof n && ((i = o), (o = n), (n = t)),
          r.guid && (a.guid = o.guid = o.guid || r.guid++),
          a
        );
      }),
    ...
    function (e) {
      ...
      var t = {
        ...
        l = function (t, n, r, o) {
          ...
          return (
            (i = Math.max(i - n - r, 0)),
            o && (i = Math.min(i, u() - e.innerHeight)),
            i
          );
        },
        c = function (e) {
        ...
        g = function (i, g) {
          ...
          (T.cancelScroll = function (e) {
            ...
            (T.animateScroll = function (n, i, a) {
              T.cancelScroll();
              var d = r(v || t, a || {}),
                g = "[object Number]" === Object.prototype.toString.call(n),
                y = g || !n.tagName ? null : n;
              if (g || y) {
                var b = e.pageYOffset;
                d.header && !x && (x = document.querySelector(d.header));
                var w,
                  E,
                  S,
                  k = c(x),
                  ...
                  D = function (t, r) {
                    var o = e.pageYOffset;
                    return t == r || o == r || (r > b && e.innerHeight + o) >= j
                      ? (T.cancelScroll(!0),
                        h(n, r, g),
                        m("scrollStop", d, n, i),
                        (w = null),
                  ...
                  O = function (t) {
                    w || (w = t),
                      ...
                      D(S, A) || ((C = e.requestAnimationFrame(O)), (w = t));
                  };
                if ((0 === e.pageYOffset && e.scrollTo(0, 0), p(n, g, d), o()))
                  return void e.scrollTo(0, Math.floor(A));
                m("scrollStart", d, n, i),
                  T.cancelScroll(!0),
          ...
          var E = function (t) {
              if (
                ...
                "closest" in t.target &&
                ((b = t.target.closest(i)),
                b &&
                  "a" === b.tagName.toLowerCase() &&
                  !t.target.closest(v.ignore) &&
                  b.hostname === e.location.hostname &&
                  b.pathname === e.location.pathname &&
                  /#/.test(b.href))
              ) {
                var n;
                try {
                  n = a(decodeURIComponent(b.hash));
                } catch (r) {
                  n = a(b.hash);
                }
                var o;
                ...
                (o = o || "#top" !== n ? o : document.documentElement),
                  o && (t.preventDefault(), d(v), T.animateScroll(o, b));
              }
            },
            S = function (e) {
              if (
                ...
                ("string" == typeof t &&
                  ...
                  T.animateScroll(t, null, { updateURL: !1 });
              }
            };
          T.destroy = function () {
            v &&
              (document.removeEventListener("click", E, !1),
              e.removeEventListener("popstate", S, !1),
              T.cancelScroll(),
              (v = null),
              (y = null),
              (b = null),
          ...
          var k = function () {
            ...
            T.destroy(),
              (v = r(t, g || {})),
              (x = v.header ? document.querySelector(v.header) : null),
              document.addEventListener("click", E, !1),
              v.updateURL &&
                v.popstate &&
                e.addEventListener("popstate", S, !1);
          };
          return k(), T;
        };
      return g;
        ...
        g = function (r, o) {
          ...
          (d.setup = function () {
            ...
            (d.detect = function () {
              ...
              return e
                ? void (
                    (u && e.content === u.content) ||
                    (p(u, c), m(e, c), (u = e))
                  )
                : void (u && (p(u, c), (u = null)));
            });
          var h = function (t) {
              l && e.cancelAnimationFrame(l),
                (l = e.requestAnimationFrame(d.detect));
            },
            g = function (t) {
              l && e.cancelAnimationFrame(l),
          ...
          d.destroy = function () {
            u && p(u, c),
              e.removeEventListener("scroll", h, !1),
              c.reflow && e.removeEventListener("resize", g, !1),
              (s = null),
              (a = null),
              (u = null),
              (l = null),
          ...
          var v = function () {
            (c = n(t, o || {})),
              d.setup(),
              d.detect(),
              e.addEventListener("scroll", h, !1),
              c.reflow && e.addEventListener("resize", g, !1);
          };
          return v(), d;
        };
      return g;
